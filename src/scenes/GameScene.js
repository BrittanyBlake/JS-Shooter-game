export default class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("front-grass-BG", "assets/images/front-grass-BG.png");
  }
  ...
  create() {
    ...
    // this.cloud1 = this.add.image(0, height * 0.35, "cloud1").setOrigin(0, 1);
    // this.clouds1.setScale(0.5, 0.5);
    // this.cloud2 = this.add.image(0, height * 0.35, "cloud2").setOrigin(0, 1);
    // this.clouds2.setScale(0.5, 0.5);
    // this.cloud3 = this.add.image(0, height * 0.35, "cloud3").setOrigin(0, 1);
    // this.clouds3.setScale(0.5, 0.5);
    this.cloud4 = this.add.image(0, height * 0.35, "cloud4").setOrigin(0, 1);
    this.clouds4.setScale(0.5, 0.5);
